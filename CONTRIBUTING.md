...
Thank you for your interest in contributing to Archimedes! This document provides guidelines and instructions for contributing.
...
```bash
# Navigate to the archimedes workspace
cd archimedes
