...
pub struct SchemaValidator {
    ...
    /// Compiled JSON schemas by reference.
...
impl SchemaValidator {
    ...
    pub fn from_artifact(artifact: &LoadedArtifact, config: ValidationConfig) -> Self {
        let schemas: HashMap<String, Value> = artifact
            .schemas
            .iter()
    ...
    pub fn validate_request(
        ...
        self.validate_against_schema(schema_ref, body)
    }
    ...
    fn validate_against_schema(
        ...
        // For now, perform basic type validation
        // Full JSON Schema validation would use a library like jsonschema
        let errors = self.validate_value(value, schema_ref, "");
